...
export function SiteFooter() {
  return (
    <footer className="border-t border-[#2a2d33] bg-void py-[72px] text-paper">
      <div className="mx-auto grid max-w-[1180px] grid-cols-1 gap-16 px-8 md:grid-cols-[1.3fr_1fr]">
        <div>
          ...
          <p className="max-w-[44ch] text-[1.02rem] text-[#b8bbc0]">
      ...
      <div className="mx-auto mt-11 max-w-[1180px] border-t border-[#2a2d33] px-8 pt-[26px] text-center text-[0.82rem] leading-[1.8] text-[#8b8f96]">
        <p>
